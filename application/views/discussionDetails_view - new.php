...
<div class="container fluid">
    ...
    <div class="list-group list-group-item container fluid">
    ...
    <div class="list-group" style="margin-left:20px" id="easyPaginate" name="easyPaginate">
        ...
        //$UUID=$six_digit_random_string.$did;
        //$six_digit_random_string =  $this -> generateRandomString();
        $UUID = $randomString1.$did;
        $UUID = $UUID.$randomString2;
        //echo $randomString;
        //echo $UUID;
    ...
    <a href="javascript:fbshareCurrentPage('<?php echo $url; ?>')" target="_blank" alt="Share on Facebook">Facebook</a>
    <a href="javascript:tweetCurrentPage('<?php echo $url; ?>')" target="_blank" alt="Share on Twitter">Twitter</a>
...
<script type="text/javascript">
    ...
    { window.open("https://twitter.com/share?url="+escape($url)+"&text="+document.title, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false; }
